...
def fix_json_v1(content: list):
    ...
    url = "https://ko.zhonghuapu.com/koapi/query_haograph/FilePhase_en"  # 接口地址
...
def export_title_structure(processed_data, input_file):
    ...
    output_path = os.path.join('./', "mix_content.json")
...
if __name__ == "__main__":
    input_path = r"./NFPA_80A-2022_original_content_list.json"
